...
> [!TIP]
> Se recomienda usar un editor de texto como [Notepad++](https://notepad-plus-plus.org/downloads/) o [VsCode](https://code.visualstudio.com/), etc.
...
> [!IMPORTANT]  
> Si utiliza el editor de textos de Windows, es probable que le agregue la extensión `.txt`. Tenga en cuenta que esto afectará la ejecución de los comandos ya que el archivo en vez de llamarse `Dockerfile` se llamará `Dockerfile.txt`.
