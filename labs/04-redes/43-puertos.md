...
En este lab aprendimos que es posible tener múltiples contenedores sirviendo servicios en el mismo puerto, siempre y cuando los puertos del host, es decir los que se exponen con `-p` no choquen entre sí.
--------
