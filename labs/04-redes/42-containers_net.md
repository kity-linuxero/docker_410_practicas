...
En este lab hemos creado una red custom y hemos verificado que es posible la comunicación entre contenedores, utilizando sus nombres como DNS. Además verificamos que no es posible acceder a los servicios corriendo en los contenedores si no se mapean los puertos al host pero sí es posible hacerlo desde otros contenedores en la misma red.
